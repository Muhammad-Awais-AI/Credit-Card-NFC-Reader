package com.itroos.creditCardNfcReader;
...
import com.itroos.creditCardNfcReader.parser.EmvParser;
import com.itroos.creditCardNfcReader.utils.Provider;
...
/**
 * updated by muhammad awais on 10.16.20.
 */
public class CardNfcAsyncTask extends AsyncTask<Void, Void, Object>{
    ...
    private final String UNKNOWN_CARD_MESS =
            "===========================================================================\n\n"+
                    ...
                    "Here is my email: awaismalik934@gmail.com. \n\n" +
                    "===========================================================================";
